...
# CHANGE MANAGEMENT PHASE TEMPLATES

---
```yaml
Artifact_ID: DOC-00-README
Artifact_Name: CHANGE MANAGEMENT PHASE TEMPLATES
Artifact_Type: DOC
Version: v1.0
Status: Draft
Owner: Enterprise Architecture Office (EAO)
Last_Updated: 2025-10-25
Description: Master index and usage guide for all Change Management Phase (08_Change_Management) templates in ELA projects
File_Path: 00_Policy/Templates/08_Change_Management/README.md
GitHub_URL: https://github.com/EhsanLasani/ELA-Main/blob/main/00_Policy/Templates/08_Change_Management/README.md
...
| Artifact Name     | CHANGE MANAGEMENT PHASE TEMPLATES                                         |
| Artifact Type     | DOC                                                                       |
| Version           | v1.0                                                                      |
| Status            | Draft                                                                     |
| Owner             | Enterprise Architecture Office (EAO)                                      |
| Last Updated      | 2025-10-25                                                                |
| Description       | Master index and usage guide for all Change Management Phase templates     |
| File Path         | 00_Policy/Templates/08_Change_Management/README.md                        |
| GitHub URL        | https://github.com/EhsanLasani/ELA-Main/blob/main/00_Policy/Templates/08_Change_Management/README.md |
| Phase             | Change Management                                                         |
| Dependencies      | None                                                                      |
...
## Overview
This folder contains the master templates for the Change Management Phase (`08_Change_Management`) of the ELA-Main governance framework. Use these templates to ensure all change management activities are consistent, controlled, and standards-compliant.

## How to Use These Templates
1. **Do not edit these master templates directly.**
2. **Copy** the required template to your project or phase folder (`08_Change_Management/`).
